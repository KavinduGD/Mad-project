    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try{
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                ...
                                if(task.isSuccessful()){
                                    ...
                                    if(Fauth.getCurrentUser().isEmailVerified()){
                                        ...
                                        Intent Z = new Intent(CustomerLogin.this,CustomerBottomNavigation.class);
                                        startActivity(Z);
                                        finish();
            ...
            signup.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    startActivity(new Intent(CustomerLogin.this,CustomerSignIn.class));
                    finish();
                }
            });
            ...
            Signinphone.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    startActivity(new Intent(CustomerLogin.this,CustomerPhoneLogin.class));
                    finish();
                }
            });
        }catch (Exception e){
