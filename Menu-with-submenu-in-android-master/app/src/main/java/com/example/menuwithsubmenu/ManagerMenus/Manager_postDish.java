...
import com.example.menuwithsubmenu.ManagerSignIn;
...
public class Manager_postDish extends AppCompatActivity {
    ...
    String ManagerID , RandomUID , State, City , Area;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_manager_post_dish);
        ...
        try {
            ...
            dataa = firebaseDatabase.getInstance().getReference("Manager").child(userid);
    ...
    private void uploadImage() {
        ...
        if(imageuri != null){
            final ProgressDialog progressDialog = new ProgressDialog(Manager_postDish.this);
            ...
            ref.putFile(imageuri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ref.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                        ...
                        public void onSuccess(Uri uri) {
                            FoodDetails info = new FoodDetails(dishes,quantity,price,descrption,String.valueOf(uri),RandomUID, ManagerID);
                            firebaseDatabase.getInstance().getReference("FoodDetails").child(State).child(City).child(Area).child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child(RandomUID)
                                    .setValue(info).addOnCompleteListener(new OnCompleteListener<Void>() {
                                        ...
                                        public void onComplete(@NonNull Task<Void> task) {
                                            ...
                                            Toast.makeText(Manager_postDish.this,"Dish Posted Successfully!",Toast.LENGTH_SHORT).show();
                                        }
                                    });
                ...
                public void onFailure(@NonNull Exception e) {
                    progressDialog.dismiss();
                    Toast.makeText(Manager_postDish.this,e.getMessage(),Toast.LENGTH_SHORT).show();
                }
